...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        Validator::extend('valid_captcha', function ($attribute, $value, $parameters, $validator) {
            $payload = [
                'secret' => Config::get('Constant.GOOGLE_CAPTCHA_SECRET'),
                'response' => $value,
            ];
        ...
        Validator::extend('check_phoneformat', function ($attribute, $value, $parameters, $validator) {
            if (!empty($value)) {
        ...
        Validator::replacer('check_phoneformat', function ($message, $attribute, $rule, $parameters) {

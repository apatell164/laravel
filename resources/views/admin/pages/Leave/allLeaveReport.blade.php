...
<div class="shadow p-4 d-flex justify-content-between align-items-center">
    <h4 class="text-uppercase">Leave Record</h4>
     ...
     <div>
        <a href="{{ route('leave.leaveStatus') }}" class="btn btn-success p-2 text-lg rounded-pill"><i
                class="fa-solid fa-plus  me-1"></i>Leave Request</a>
    </div>
</div>
        ...
        <div class="">
            <div class="">
                <div class="card-header p-4">
                    <a class="pt-2 d-inline-block" href="" data-abc="true">R R innfrastructure</a>
                ...
                <div class="card-footer bg-dark-light p-1 rounded text-center mt-5">
                    <p class="mb-0">© 2023 Copyright: Employee Management System</p>
                </div>
            </div>
        </div>
    </div>
